(function( $ ){
  ...
  $(document).on('click','ul.fa-ul i',function(){
		var stor = $(this).parent().toggleClass('open')
		if(stor.is('.open')){
			stor.children('ul').addClass('in').attr('aria-expanded','true')
			$(this).removeClass('fa-caret-right').addClass('fa-caret-down')
		}else{
			stor.children('ul').removeClass('in').attr('aria-expanded','false')
